...
#
#
# class MyFixedArray(xdrlib.FixedArray, size=10, itemtype=xdrlib.Integer):
#     pass
#
#
# class MyVarArray(xdrlib.VarArray):
#     size = 10
#     itemtype = xdrlib.UnsignedHyper
#
#
# class MyEnumVarArray(xdrlib.VarArray):
#     size = 10
#     itemtype = xdrlib.Enumeration.typedef('Color', RED=2, YELLOW=3, BLUE=5)
#
#
...
#            b''.join(xdrlib.UnsignedHyper.encode() for x in int_list)
...
#
#
# def test_substring_modification_works_for_variable_length(MyVarArray):
...
#
#
# def test_substring_modification_fails_if_size_exceeds_maximum_length(MyVarArray):
#     b = MyVarArray(range(5))
#     with pytest.raises(ValueError):
#         b[3:5] = range(10)
#     with pytest.raises(ValueError):
